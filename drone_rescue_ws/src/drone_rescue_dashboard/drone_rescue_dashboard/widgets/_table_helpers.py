...
identical in ``StateTableWidget``,
``VictimsTableWidget`` (this package) and Mission Control's
``PastRunsTab``. Each class now delegates to this free function, so
a future change (tooltips, alignment) is one edit.

Stays in the dashboard package (mirrored in mission_control) because
